...
export default {
  ...
  'your fingerprint, face or PIN': 'parmak iziniz, yüzünüz veya PIN',
  'Don’t have one? Ask your coach.': 'Kodunuz yok mu? Koçunuza sorun.',
  'First time here?': 'İlk kez mi buradasınız?',
  'Tap “Create new profile”, enter your name{0} and confirm with {1}.': '“Yeni profil oluştur”a dokunun, adınızı{0} girin ve {1} ile onaylayın.',
  ' and your invite code': ' ve davet kodunuzu',
  'Already have a profile?': 'Zaten profiliniz var mı?',
  'Tap “Sign in with passkey”.': '“Passkey ile giriş yap”a dokunun.',
  'Privacy': 'Gizlilik',
  'Terms': 'Koşullar',
}
